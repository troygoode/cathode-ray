...
import map from "@/cassettes/ypsilon14/ypsilon14-map-2.png";
    ...
    <Screen id="schedule">
      ...
      <Timeline
        ...
        events={[
          ...
          [30, ["Bay 2", "Depart", "CTV HORN OF PLENTY"]],
          [31, ["Bay 2", "Arrive", "CTV HORN OF PLENTY"]],
...
export default function CassetteComponent() {
  return (
    <Cassette
      ...
      comment='The security code is "PRINCE"'
    >
      <Y14Home />
      <Y14Menu />
      <Y14Schematic />
